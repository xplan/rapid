...
public class UserInfoController {
	 ...
	 * 根据订单号查询订单
	 */
	@RequestMapping(value="/testOpenClose",method=RequestMethod.GET
)
	public PageList testOpenClose(ModelMap model,TestOpenCloseQuery param) throws DataAccessException {
		Result result = UserInfoFacade.testOpenClose(param);
		model.addAttribute();
	}
	/**
	 * 根据订单号查询订单
