...
public class GeneratorHelperTest extends TestCase {
    ...
    public void test() {
        ...
        //        assertEquals(
        //                "[macro.include, \\macro.include, \\1\\macro.include, \\1\\2\\macro.include, \\1\\2\\3\\macro.include]",
        //                list.toString());
        //
        //        list = GeneratorHelper.getParentPaths("/1/2", "macro.include");
        //        assertEquals("[macro.include, \\macro.include, \\1\\macro.include, \\1\\2\\macro.include]",
        //                list.toString());
        //
